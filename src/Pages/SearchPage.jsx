        ...
        <Grid item key={book.id} xs={12} sm={6} md={4} lg={3}>
          <Card style={{ maxWidth: 274,marginTop:'30px' }}>
            ...
            <CardContent  style={{ boxShadow: 'none' }}>
              <Typography style={{ fontSize: '24px', fontWeight: '600', overflow: 'hidden', whiteSpace: 'nowrap', textOverflow: 'ellipsis' }} variant="subtitle1">
                {book.volumeInfo.title || "No Title"}
              </Typography>
              <Typography style={{ fontSize: '16px', fontWeight: '400', overflow: 'hidden', whiteSpace: 'nowrap', textOverflow: 'ellipsis' }} variant="body2" color="text.secondary">
